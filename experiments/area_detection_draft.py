# Earlier draft of src/area_detection.py, kept for reference.
    ...
    for cnt in contours:
        ...
        if area > 400:
            if len(approx) == 4:
                ...
                area_location((0, 0), (214, 160), (center_x, center_y), "Top-Left")
                area_location((214, 0), (428, 160), (center_x, center_y), "Top")
                area_location((428, 0), (640, 160), (center_x, center_y), "Top-Right")
                area_location((0, 160), (214, 320), (center_x, center_y), "Left")
                area_location((214, 160), (428, 320), (center_x, center_y), "Center")
                area_location((428, 160), (640, 320), (center_x, center_y), "Right")
                area_location((0, 320), (214, 480), (center_x, center_y), "Bottom-Left")
                area_location((214, 320), (428, 480), (center_x, center_y), "Bottom")
                area_location((428, 320), (640, 480), (center_x, center_y), "Bottom-Right")
            else:
